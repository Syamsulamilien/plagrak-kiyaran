        ...
        <FadeIn>
          <div className="relative overflow-hidden rounded-4xl bg-primary-700 px-6 py-14 sm:px-16 sm:py-20 text-center">
            ...
            <div className="relative">
              <span className="badge-eyebrow text-primary-100 justify-center"><Landmark className="h-3.5 w-3.5 text-gold-300" />Kenali Lebih Dekat</span>
              <h2 className="mt-4 text-2xl sm:text-4xl font-display font-bold text-white max-w-2xl mx-auto leading-tight">Ingin tahu lebih banyak tentang Plagrak Kiyaran?</h2>
